...
/*      else{
   ...
   * {@link readds} javadoc for more information.
   */
  ...
  /**
   * Options supported by {@link readds}.
   *
  ...
  public static void readDataFromDatastore(Options options) {
    ...
    p.apply("ReadFromDatastore", read)
  ...
  public static void main(String args[]) {
    ...
    readds.readDataFromDatastore(options);
  }
}
